...
Mobile.tap(findTestObject('Home/Portfolio/Reedem/android.widget.FrameLayout11'), 0)
...
Mobile.tap(findTestObject('Home/Portfolio/Reedem/android.widget.TextView11 - JUAL (1)'), 0)
